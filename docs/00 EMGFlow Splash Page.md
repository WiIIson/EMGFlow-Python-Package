<img src="images\HexSticker.png"  width="100" height="110" style="float: right;">
# EMGFlow
...
General
- [[02 Background|EMG processing background]]
- [[03 Processing Pipeline|EMGFlow processing pipeline overview]]
- [[04 SignalFilterer Documentation|SignalFilterer module EMG processing documentation]]
- [[05 ExtractFeatures Feature Documentation|SignalFilterer module feature extraction documentation]]
- [[06 OutlierFinder Documentation|OutlierFinder module documentation]]
- [[07 PlotSignals Documentation|PlotSignals module documentation]]

Examples
- [[01 Examples|Processing pipeline examples]]
